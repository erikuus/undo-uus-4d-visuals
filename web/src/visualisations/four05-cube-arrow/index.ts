...
export function createVisualization(canvas: HTMLCanvasElement): {
  ...
  const frame = () => {
    ...
    renderStereo(ctx, vertices, edges, arrow, rotationState, {
