import { getVertexArray, getEdges } from "./cube";
import { renderStereo } from "./renderer";
import type { RotationState } from "./math4d";

const TWO_PI = 2 * Math.PI;

// Original rotation speeds from QBasic four04.bas (same as four03)
