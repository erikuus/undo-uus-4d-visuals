' 3-D risttahuka po"o"rlemine 4-D ruumis. Ko"ik servjooned na"htavad.
' Monokromaatne. Po"o"rlemistsenter ta"histatud punase ta"piga.
...
DO
  ...
  FOR ISTEREO = 1 TO 2
    ...
    FOR J = 1 TO 2
    FOR K = 1 TO 2
      TIP2(I, J, K, 1) = TIP4(I, J, K, 1, 1) * C - TIP4(I, J, K, 1, 3) * S
      TIP2(I, J, K, 2) = TIP4(I, J, K, 1, 2)
    NEXT K
    NEXT J
    NEXT I
