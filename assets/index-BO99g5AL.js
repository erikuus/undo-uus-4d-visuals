(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(e){if(e.ep)return;e.ep=!0;const s=o(e);fetch(e.href,s)}})();function L(t,r,o,i){const e=Math.sin(i),s=Math.cos(i),a=t[r],c=t[o];return{...t,[r]:a*s-c*e,[o]:a*e+c*s}}function j(t,r){return L(t,"x","y",r)}function k(t,r){return L(t,"x","z",r)}function N(t,r){return L(t,"y","z",r)}function Y(t,r){return L(t,"x","w",r)}function B(t,r){return L(t,"y","w",r)}function V(t,r){return L(t,"z","w",r)}const H=2*Math.PI,b=124.7354645891,A={xy:3.034538902655*b,xz:5.028469563403*b,yz:7.037635209575*b,xw:11.06479853421*b,yw:13.08750265132*b,zw:17.00573092632*b};function T(t){for(;t>=H;)t-=H;for(;t<0;)t+=H;return t}function Z(t){const r=[],o={xy:0,xz:0,yz:0,xw:0,yw:0,zw:0};for(let i=0;i<t;i+=1){let e={x:1,y:.7,z:.8,w:.9};o.xy=T(o.xy+A.xy),e=j(e,o.xy),o.xz=T(o.xz+A.xz),e=k(e,o.xz),o.yz=T(o.yz+A.yz),e=N(e,o.yz),o.xw=T(o.xw+A.xw),e=Y(e,o.xw),o.yw=T(o.yw+A.yw),e=B(e,o.yw),o.zw=T(o.zw+A.zw),e=V(e,o.zw),r.push(e)}return r}function G(t,r,o,i,e){const{stereoHalfAngle:s,pointRadius:a,scaleX:c,palette:f,background:p}=i,h=t.canvas.width,u=t.canvas.height,y=h/2-h/4,x=h/2+h/4,w=Math.sin(s),z=Math.cos(s),M=Math.sin(e),E=Math.cos(e);t.fillStyle=p,t.fillRect(0,0,h,u);for(let m=0;m<r.length;m+=1){const l=r[m];if(l.w*E-l.x*M<0)continue;const v=l.w*M+l.x*E,P=l.z,I=v*z+P*w,R=v*z-P*w,O=I*c+y,_=R*c+x,$=o[m];t.fillStyle=f[m%f.length],t.beginPath(),t.arc(O,$,a,0,Math.PI*2),t.fill(),t.beginPath(),t.arc(_,$,a,0,Math.PI*2),t.fill()}}const K=1e3,Q=.03,J=.15*.5,tt=["#0000aa","#00aa00","#00aaaa","#ffff55"];function ot(t){const r=(()=>{const c=t.getContext("2d");if(!c)throw new Error("Unable to acquire 2D rendering context.");return c})(),o=Z(K);let i=0,e=[];const s=()=>{const c=t.parentElement;if(c){const h=c.getBoundingClientRect(),u=Math.max(320,Math.floor(h.width)),y=Math.floor(window.innerHeight*.65),x=Math.max(240,Math.min(y,Math.floor(u*(350/640))));t.width=u,t.height=x}else t.width=640,t.height=350;const f=t.height/350*70,p=t.height/2;e=o.map(h=>h.y*f+p)},a=()=>{i+=Q,i>=Math.PI*2&&(i-=Math.PI*2);const c=t.width/640*80;t.height/350*70,G(r,o,e,{stereoHalfAngle:J,pointRadius:2,scaleX:c,palette:tt,background:"#000000"},i),requestAnimationFrame(a)};return s(),requestAnimationFrame(a),{resize:s}}const U=.99,X=.61,F=.86,W=.74;function et(){const t=[];for(let r=0;r<2;r++)for(let o=0;o<2;o++)for(let i=0;i<2;i++)for(let e=0;e<2;e++)t.push({x:r===0?U:-U,y:o===0?X:-X,z:i===0?F:-F,w:e===0?W:-W});return t}function n(t,r,o,i){return t*8+r*4+o*2+i}function nt(){return[{from:n(0,0,0,0),to:n(1,0,0,0),color:1},{from:n(0,1,0,0),to:n(1,1,0,0),color:2},{from:n(0,0,1,0),to:n(1,0,1,0),color:3},{from:n(0,1,1,0),to:n(1,1,1,0),color:4},{from:n(0,0,0,1),to:n(1,0,0,1),color:4},{from:n(0,1,0,1),to:n(1,1,0,1),color:3},{from:n(0,0,1,1),to:n(1,0,1,1),color:2},{from:n(0,1,1,1),to:n(1,1,1,1),color:1},{from:n(0,0,0,0),to:n(0,1,0,0),color:5},{from:n(1,0,0,0),to:n(1,1,0,0),color:6},{from:n(0,0,1,0),to:n(0,1,1,0),color:7},{from:n(1,0,1,0),to:n(1,1,1,0),color:7},{from:n(0,0,0,1),to:n(0,1,0,1),color:7},{from:n(1,0,0,1),to:n(1,1,0,1),color:7},{from:n(0,0,1,1),to:n(0,1,1,1),color:6},{from:n(1,0,1,1),to:n(1,1,1,1),color:5},{from:n(0,0,0,0),to:n(0,0,1,0),color:8},{from:n(1,0,0,0),to:n(1,0,1,0),color:9},{from:n(0,1,0,0),to:n(0,1,1,0),color:10},{from:n(1,1,0,0),to:n(1,1,1,0),color:11},{from:n(0,0,0,1),to:n(0,0,1,1),color:11},{from:n(1,0,0,1),to:n(1,0,1,1),color:10},{from:n(0,1,0,1),to:n(0,1,1,1),color:9},{from:n(1,1,0,1),to:n(1,1,1,1),color:8},{from:n(0,0,0,0),to:n(0,0,0,1),color:12},{from:n(1,0,0,0),to:n(1,0,0,1),color:13},{from:n(0,1,0,0),to:n(0,1,0,1),color:14},{from:n(1,1,0,0),to:n(1,1,0,1),color:15},{from:n(0,0,1,0),to:n(0,0,1,1),color:15},{from:n(1,0,1,0),to:n(1,0,1,1),color:14},{from:n(0,1,1,0),to:n(0,1,1,1),color:13},{from:n(1,1,1,0),to:n(1,1,1,1),color:12}]}function rt(t,r){let o={...t};const i=Math.sin(r.xy),e=Math.cos(r.xy),s=o.x*e+o.y*i,a=-o.x*i+o.y*e;o.x=s,o.y=a;const c=Math.sin(r.xz),f=Math.cos(r.xz),p=o.x*f+o.z*c,h=-o.x*c+o.z*f;o.x=p,o.z=h;const u=Math.sin(r.yz),y=Math.cos(r.yz),x=o.y*y+o.z*u,w=-o.y*u+o.z*y;o.y=x,o.z=w;const z=Math.sin(r.xw),M=Math.cos(r.xw),E=o.x*M+o.w*z,m=-o.x*z+o.w*M;o.x=E,o.w=m;const l=Math.sin(r.yw),g=Math.cos(r.yw),v=o.y*g+o.w*l,P=-o.y*l+o.w*g;o.y=v,o.w=P;const I=Math.sin(r.zw),R=Math.cos(r.zw),O=o.z*R+o.w*I,_=-o.z*I+o.w*R;return o.z=O,o.w=_,o}function it(t,r){const o=Math.sin(r),i=Math.cos(r);return{x:t.x*i-t.z*o,z:t.x*o+t.z*i}}function st(t,r,o,i,e){const{stereoHalfAngle:s,scaleX:a,scaleY:c,palette:f,background:p,lineWidth:h}=e,u=t.canvas.width,y=t.canvas.height;t.fillStyle=p,t.fillRect(0,0,u,y);const x=r.map(w=>rt(w,i));for(let w=0;w<2;w++){const z=w===0?u/4:u/4*3,M=y/2,E=w===0?s:-s,m=[];for(const l of x){const g=it({x:l.x,z:l.z},E);m.push({x:g.x*a+z,y:l.y*c+M})}t.lineWidth=h;for(const l of o){const g=m[l.from],v=m[l.to];t.strokeStyle=f[l.color-1]||f[f.length-1],t.beginPath(),t.moveTo(g.x,g.y),t.lineTo(v.x,v.y),t.stroke()}}}const d=2*Math.PI,S=5,C={xy:.0055*S,xz:.0027*S,yz:.0034*S,xw:2e-4*S,yw:.0039*S,zw:.0091*S},ct=.15*.5,at=["#ffffff","#0000aa","#00aa00","#005555","#00aa00","#00aa55","#00aaaa","#00aaff","#aaaa00","#aaaa55","#55ff55","#55ffaa","#55ffff","#ffff55","#ffffff"];function lt(t){const r=(()=>{const c=t.getContext("2d");if(!c)throw new Error("Unable to acquire 2D rendering context.");return c})(),o=et(),i=nt(),e={xy:0,xz:0,yz:0,xw:0,yw:0,zw:0},s=()=>{const c=t.parentElement;if(c){const f=c.getBoundingClientRect(),p=Math.max(320,Math.floor(f.width)),h=Math.floor(window.innerHeight*.65),u=Math.max(240,Math.min(h,Math.floor(p*(350/640))));t.width=p,t.height=u}else t.width=640,t.height=350},a=()=>{e.xy+=C.xy,e.xz+=C.xz,e.yz+=C.yz,e.xw+=C.xw,e.yw+=C.yw,e.zw+=C.zw,e.xy>d&&(e.xy-=d),e.xz>d&&(e.xz-=d),e.yz>d&&(e.yz-=d),e.xw>d&&(e.xw-=d),e.yw>d&&(e.yw-=d),e.zw>d&&(e.zw-=d);const c=t.width/640*80,f=t.height/350*70;st(r,o,i,e,{stereoHalfAngle:ct,scaleX:c,scaleY:f,palette:at,background:"#000000",lineWidth:1.5}),requestAnimationFrame(a)};return s(),requestAnimationFrame(a),{resize:s}}const D={four16:{create:ot,title:"4D Sphere (S³) – W-Gated Stereo",description:"A 4D point cloud on the 3-sphere, with perceptual W-gate hiding half the space."},four01:{create:lt,title:"4D Tesseract – Rotating Hyperrectangle",description:"A 4D rectangular parallelepiped rotating through all six 4D planes."}};function ft(){const t=window.location.hash.slice(1);return t in D?t:null}function ht(){const t=document.getElementById("app");t&&(t.innerHTML=`
    <div class="landing">
